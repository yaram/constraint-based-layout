function initControls(memory, frame, buttonPressHandler, frameResizeHandler, textInputChangeHandler) {
    ...
    function encodeString(string, buffer) {
        new Uint8Array(memory.buffer).set(textEncoder.encode(string), buffer);
    }
